...
@Singleton
public final class HikeViewModelFactory implements ViewModelProvider.Factory {

    private final Map<Class<? extends ViewModel>, Provider<ViewModel>> classProviderMap;

    @Inject
    public HikeViewModelFactory(Map<Class<? extends ViewModel>, Provider<ViewModel>> classProviderMap) {
